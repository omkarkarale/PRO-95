      ...
      return (
          ...
          <View style={styles.appTitle}>
            ...
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Recipes</Text>
            </View>
          </View>
          <View style={styles.storyContainer}>
            <ScrollView style={styles.storyCard}>
              <Image
                source={require("../assets/recipe_image_1.png")}
                style={styles.image}
              ></Image>
              ...
              <View style={styles.dataContainer}>
                <View style={styles.titleTextContainer}>
                  ...
                  <Text style={styles.storyAuthorText}>
                    Preparation Time: {this.props.route.params.story.preparation_time}
                  </Text>
                  <Text style={styles.storyAuthorText}>
                    Total Time: {this.props.route.params.story.total_time}
                  </Text>
                </View>
